            ...
            <section className="relative h-[60vh] flex items-center justify-center overflow-hidden">
                ...
                <div className="container mx-auto px-4 z-10 text-center">
                    <h1 className="text-4xl md:text-6xl font-bold text-white mb-6">
                        {t('resourceMap.heroTitle')} <span className="text-primary-400">{t('resourceMap.heroTitleHighlight')}</span>
                    </h1>
                    <p className="text-xl text-gray-200 max-w-2xl mx-auto font-light leading-relaxed">
                        {t('resourceMap.heroSubtitle')}
                    </p>
                </div>
            </section>
                    ...
                    <div className="glass-card overflow-hidden border border-gray-100 dark:border-gray-800 shadow-2xl">
                        <div className="grid grid-cols-1 md:grid-cols-2">
                            <div className="p-8 md:p-12">
                                <span className="text-primary-600 dark:text-primary-400 font-bold uppercase tracking-wider text-sm mb-4">{t('resourceMap.freeResource')}</span>
                                <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-6">{t('resourceMap.downloadTitle')}</h2>
                                <p className="text-gray-600 dark:text-gray-300 mb-8 text-lg">
                                    {t('resourceMap.downloadDesc')}
                                </p>

                                <div className="space-y-4 mb-8">
                                    {[t('resourceMap.feature1'), t('resourceMap.feature2'), t('resourceMap.feature3'), t('resourceMap.feature4')].map(item => (
                                ...
                                <div className="bg-white dark:bg-gray-900 p-8 rounded-2xl shadow-xl relative z-10 glass-card border-none">
                                    {!downloaded ? (
                                        <form onSubmit={handleDownload} className="space-y-4">
                                            <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-4">{t('resourceMap.formTitle')}</h3>
                                            <div>
                                                <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">{t('resourceMap.formName')}</label>
                                            ...
                                            <div>
                                                <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">{t('resourceMap.formEmail')}</label>
                                            ...
                                            <Button className="w-full" size="lg">{t('resourceMap.formButton')}</Button>
                                        </form>
                                    ) : (
                                        <div className="text-center py-12">
                                            ...
                                            <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-2">{t('resourceMap.successTitle')}</h3>
                                            <p className="text-gray-600 dark:text-gray-300 mb-6">{t('resourceMap.successSubtitle')}</p>
                                            <a 
