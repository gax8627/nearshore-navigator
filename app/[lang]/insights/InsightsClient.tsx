        ...
        <div className="pb-20 overflow-hidden">
            ...
            <section className="relative min-h-[50vh] py-32 flex items-center justify-center overflow-hidden">
                ...
                <div className="container mx-auto px-4 z-10 text-center">
                    <h1 className="text-4xl md:text-6xl font-bold text-white mb-6">{t('insights.heroTitle')}</h1>
            ...
            <div className="container mx-auto px-4 mt-12">
                ...
                <div className="bg-white dark:bg-gray-800 rounded-3xl p-8 border border-gray-100 dark:border-gray-700 shadow-xl mb-16 relative overflow-hidden">
                    ...
                    <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-12 relative z-10">
                        <div>
                            ...
                            <h2 className="text-3xl font-bold text-gray-900 dark:text-white">{t('insights.dashboardTitle')}</h2>
                            <p className="text-gray-600 dark:text-gray-400">{t('insights.dashboardSubtitle')}</p>
                        </div>
                        <div className="flex items-center gap-3 text-sm text-gray-500">
                            <span className="flex items-center gap-1"><span className="w-2 h-2 rounded-full bg-green-500 animate-pulse" /> {t('insights.dashboardBadge')}</span>
                            <span className="px-2 py-1 bg-gray-100 dark:bg-gray-700 rounded text-xs font-medium">{t('insights.dashboardUpdated')} 2026-02</span>
                        </div>
                    </div>
                ...
                <div className="flex items-center justify-between mb-8">
                    <h2 className="text-3xl font-bold text-gray-900 dark:text-white">{t('insights.deepDives')}</h2>
                </div>
