                    ...
                    <div>
                        ...
                        <ul className="space-y-4 text-sm text-gray-300">
                            ...
                            <li className="pt-2 flex items-center gap-4">
                                ...
                                <a href="https://linkedin.com/company/nearshore-navigator" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-blue-400 transition-colors" aria-label="LinkedIn Profile">
