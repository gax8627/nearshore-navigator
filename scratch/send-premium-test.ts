...
async function sendPremiumTest() {
    ...
    console.log(`💎 Preparing PREMIUM Prospect-View test for Denisse...`);
    ...
    try {
        const bodyContent = `
            ...
            <p>We've prepared a 5-point **USMCA Compliance Audit** specific to your sector. Should I send the PDF over?</p>
        `;
        ...
        const sendRes = await fetch('https://api.brevo.com/v3/smtp/email', {
            ...
            body: JSON.stringify({
                ...
                subject: 'July USMCA Rules of Origin Shift?',
        ...
        if (sendRes.ok) {
            ...
            console.error('❌ Failed to send premium test:', JSON.stringify(errorData, null, 2));
        }
